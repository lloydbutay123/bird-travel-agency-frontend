...
export default function FlightRoute({
  ...
  return (
    <div className="flex items-start gap-10 mb-6">
      <div className="flex gap-3 items-start">
        ...
        <div>
          <div className="flex gap-2 mb-1">
            <p className="font-semibold text-[16px] text-[#112211]">
              {departureTime}
            </p>
            <p className="font-semibold text-[16px] text-[#112211]"> - </p>
            <p className="font-semibold text-[16px] text-[#112211]">
              {arrivalTime}
            </p>
          </div>
      ...
      <div>
        <p className="font-semibold text-[16px] text-[#112211]">{duration}</p>
